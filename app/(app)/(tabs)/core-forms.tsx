...
const CORE_FORMS = [
  ...
  },
  {
    id: 'draft-list',
    title: 'Draft List',
    description: 'Create and manage draft lists for outreach planning',
    icon: '📝',
    colors: ['#22c55e', '#16a34a'] as [string, string],
    route: '/core-forms/draft-list',
  },
  {
  ...
  },
  {
    ...
    description: 'Document community-level vaccination barriers',
    icon: '👥',
  ...
  },
  {
    ...
    description: 'Document healthcare infrastructure barriers',
    icon: '🏥',
